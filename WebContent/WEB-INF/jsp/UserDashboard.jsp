...
function sendFetchReq(sportName,iD,value,userId){console.log(userId);
	$.ajax({
	    ...
	    {	$('#'+iD).empty();
	    	...
	    	var count = 0;
	    	$(data.League).each(function(index,value){$('#'+iD).append('<div onclick=javascript:redirectLeague(\''+value.id+'\',\''+userId+'\') class="content"><div class="card" style="height:80px;"><div class="profileinfo"><p style="font-size:2em;font-family:"Raleway", sans-serif; ">'+value.League+'</p><p class="bio" style="font-size: 1.5em;margin-top:-20px;font-family:"Raleway", sans-serif; ">deatils 11  13</p></div></div></div>');count++;})
